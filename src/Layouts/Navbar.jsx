...
const Navbar = () => {
  ...
  return (
    <nav className="fixed z-[999] w-full flex justify-center">
      <div className="flex w-full justify-center gap-14 bg-slate-200/60 px-6 py-3 backdrop-blur-md text-dark_primary duration-300">
        {nav.map((item, i) => (
          <a
            key={i}
            href={item.link}
